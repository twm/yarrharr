...
export function FeedIcon(props) {
    return <svg x="0" y="0" width="1em" height="1em" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" {...props}>
        <circle cx="3.5" cy="16.5" r="2.5" fill="none" stroke="#666" stroke-width="2" />
        <path d="M 1 8 A 11 11, 0, 0, 1, 12 19" fill="none" stroke="#666" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
        <path d="M 1 2 A 17 17, 0, 0, 1, 18 19" fill="none" stroke="#666" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
    </svg>;
}
